...
class ParticleFilter {  
 public:
   ...
   */
  int find_closest_landmark(double obs_x_map, double obs_y_map, const Map &map_landmarks);
  
  int find_closest_landmark_v2(double obs_x_map, double obs_y_map, const Map &map_landmarks,int part_index);
  
  void debug(const Map &map_landmarks);
